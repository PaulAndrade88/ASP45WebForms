...
public class NVPAPICaller
{
    ...
    public string APIUsername = "paag_23-facilitator_api1.hotmail.com";
    private string APIPassword = "PGZ2JXP7BDAUCZGP";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AqrTc1B9h4-hsdBGdnAb9bOUpOub";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        using (Tuts.Logic.ShoppingCartActions myCartOrders = new Tuts.Logic.ShoppingCartActions())
        {
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        {
            // Log the exception.
            Tuts.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunctions.cs");
        }
